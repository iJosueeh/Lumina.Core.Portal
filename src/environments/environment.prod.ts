export const environment = {
    ...
    noticiasEventosApiUrl: 'https://api.lumina.edu/noticias',
    docentesApiUrl: 'https://api.lumina.edu/docentes',
    carrerasApiUrl: 'https://api.lumina.edu/carreras',
    pedidosApiUrl: 'https://api.lumina.edu/pedidos'
};
